...
/**
 * Thermal Protection beeping
 */
#if defined(THERMAL_PROTECTION_HYSTERESIS_BEEP)
  #if THERMAL_PROTECTION_HYSTERESIS_BEEP < 0 || THERMAL_PROTECTION_HYSTERESIS_BEEP >= THERMAL_PROTECTION_HYSTERESIS
    #error "THERMAL_PROTECTION_HYSTERESIS_BEEP needs to be between zero and THERMAL_PROTECTION_HYSTERESIS"
  #endif
#else
  #error "You must define THERMAL_PROTECTION_HYSTERESIS_BEEP in your configuration."
#endif
#if defined(THERMAL_PROTECTION_BED_HYSTERESIS_BEEP)
  #if THERMAL_PROTECTION_BED_HYSTERESIS_BEEP < 0 || THERMAL_PROTECTION_BED_HYSTERESIS_BEEP >= THERMAL_PROTECTION_BED_HYSTERESIS
    #error "THERMAL_PROTECTION_BED_HYSTERESIS_BEEP needs to be between zero and THERMAL_PROTECTION_BED_HYSTERESIS"
  #endif
#else
  #error "You must define THERMAL_PROTECTION_BED_HYSTERESIS_BEEP in your configuration."
#endif
